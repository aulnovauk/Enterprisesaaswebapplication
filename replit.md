...
- **Dashboard Filters**: Top filter bar includes Financial Year, Month, State, Vendor, and Plant filters. Plant dropdown dynamically scopes options based on active State/Vendor selections and auto-resets when parent filters change. Uses plant ID for unique identification.
